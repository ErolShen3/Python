#NumLock on Alt + 0176 = ° https://openweathermap.org/api   https://openweathermap.org/     https://openweathermap.org/weather-conditions
import sys
import requests
...
class WeatherApp(QWidget):
    ...
    def initUI(self):
        ...
        self.setStyleSheet("""
                           ...
                           Q#temperature_label{font-size: 75px;}
    ...
    def get_weather(self):
        ...
        api_key = "ec42bb6fcf193e03fdf1166417f8c782"
        ...
        try:    
            ...
            match response.status_code:
                ...
                case 401:
                    self.display_error("Unauthozired:\nInvalid API key")
                case 403:
